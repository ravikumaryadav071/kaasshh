...
class DBblog{
	...
	private function __construct(){
		...
		try{
			$this->_pdo = new PDO('mysql:host=' . config::get('mysql_for_blog/host') .';dbname=' . config::get('mysql_for_blog/db'), config::get('mysql_for_blog/username'), config::get('mysql_for_blog/password'));
